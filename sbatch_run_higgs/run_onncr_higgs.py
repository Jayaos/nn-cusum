from onnc import run_onnc
from onnr import run_onnr
import argparse
import torch
import numpy as np
import sys
...
if __name__ == "__main__":
    ...
    run_onnc(args.hidden_dims, args.window_size, args.stride, args.learning_rate, args.epoch,
    ...
    run_onnr(args.hidden_dims, args.window_size, args.alpha, args.stride, args.learning_rate, args.epoch,
             args.f0_len, args.f1_len, args.burnin_len,
             background, 
             signal, 
             args.iter_num,
