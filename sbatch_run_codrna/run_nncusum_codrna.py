...
if __name__ == "__main__":
    ...
    signal = np.load(os.path.join(args.dataset_dir, "codrna_positive.npy"))
    background = np.load(os.path.join(args.dataset_dir, "codrna_negative.npy"))

    run_nncusum_separate_prepost(args.hidden_dims, args.window_size, args.stride, args.batch_size, args.learning_rate, 
