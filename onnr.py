...
def run_onnr_separate_prepost(hidden_dims: list, window_size: int, alpha: float, stride: int, learning_rate: float, epoch: int,
                              f0_length: int, f1_length: int, burnin_length: int,
                              f0_sequence, f1_sequence, iter_num: int, save_dir: str, device: str):
    ...
    np.savez(os.path.join(
        save_dir,
        "onnr_separate_prepost_iter{}_pre{}_post{}_b{}_d{}_l{}_a{}_s{}_w{}_e{}".format(
            iter_num,
            f0_length,
            f1_length,
            burnin_length,
